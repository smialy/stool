export namespace Types {
     ...
     */
    export function get(o: any): string {
        if (o === null) {
            return 'null';
        }
        if (o === undefined) {
     ...
     * @return {Boolean}
     */
    export const isString = (o: any) => get(o) === 'string';
    /**
    ...
    export const isSymbol = (o: any) => get(o) === 'symbol';
     ...
     * @return {Boolean}
     */
    export const isElement = (o: any) => get(o) === 'element';

    /**
     * @method stool.isTextnode
     * @return {Boolean}
     */
    export const isTextnode = (o: any) => get(o) === 'textnode';

    /**
     * @method stool.isWhitespace
     * @return {Boolean}
     */
    export const isWhitespace = (o: any) => get(o) === 'whitespace';

    /**
     * @method stool.isCollection
     * @return {Boolean}
     */
    export const isCollection = (o: any) => get(o) === 'collection';
